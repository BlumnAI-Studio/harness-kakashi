...
`.secret/openai.json` 에서 api_key, base_url 를 읽어 OpenAI Images API
(`/images/generations`, `/images/edits`) 를 호출한다.

기본 해상도는 1024x1024 이며, aspect_ratio 가 주어지면 OpenAI 가 허용하는
WxH 로 매핑한다. response_format 은 b64_json 을 우선 사용해 단일 라운드트립
으로 파일을 저장한다.
"""
...
class OpenAIImageProvider:
    ...
    def __init__(self):
        ...
        # default_model 은 chat 용일 수 있어 이미지 전용 키를 우선 사용
